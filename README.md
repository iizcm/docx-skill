...
cp -r productivity/docx ~/.hermes/skills/productivity/docx/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/docx-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/docx-skill.git ~/.hermes/skills/productivity/docx/
```
...
```text
skill_view(name="productivity/docx")
```
...
```text
Use the docx skill to <describe your specific task here>
```
...
```text
Gunakan skill docx untuk <deskripsikan tugas spesifik Anda di sini>
```
